...
product_2_f: 
  ...
  cvtsi2sd xmm1, esi     ; convierte x1 -> double
  cvtss2sd xmm0, xmm0    ; convierte f1 (float) -> double
  mulsd   xmm0, xmm1     ; double * double
  cvttsd2si eax, xmm0    ; convierte double -> int truncado
  mov      [rdi], eax    ; guarda resultado
